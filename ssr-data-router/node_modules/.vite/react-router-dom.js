...
function createMemoryHistory(options) {
  ...
  let entries;
  entries = initialEntries.map((entry, index2) => createMemoryLocation(entry, null, index2 === 0 ? "default" : void 0));
...
function createRouter(init) {
  ...
  async function handleLoaders(request, location, matches, overrideNavigation, submission, replace, pendingActionData, pendingError) {
    ...
    cancelActiveDeferreds((routeId) => !(matches != null && matches.some((m) => m.route.id === routeId)) || (matchesToLoad == null ? void 0 : matchesToLoad.some((m) => m.route.id === routeId)));
  ...
  async function handleFetcherAction(key, routeId, path, match, submission) {
    ...
    let fetcher = _extends({
      ...
      data: ((_state$fetchers$get2 = state.fetchers.get(key)) == null ? void 0 : _state$fetchers$get2.data) || void 0
    });
  ...
  async function handleFetcherLoader(key, routeId, path, match) {
    ...
    let loadingFetcher = {
      ...
      formEncType: void 0,
      formData: void 0,
      data: ((_state$fetchers$get4 = state.fetchers.get(key)) == null ? void 0 : _state$fetchers$get4.data) || void 0
    };
    state.fetchers.set(key, loadingFetcher);
    updateState({
      fetchers: new Map(state.fetchers)
...
function isNewRouteInstance(currentMatch, match) {
  ...
  return currentMatch.pathname !== match.pathname || ((_currentMatch$route$p = currentMatch.route.path) == null ? void 0 : _currentMatch$route$p.endsWith("*")) && currentMatch.params["*"] !== match.params["*"];
}
...
async function resolveDeferredResults(currentMatches, matchesToLoad, results, signal, isFetcher, currentLoaderData) {
  for (let index = 0; index < results.length; index++) {
    ...
    let isRevalidatingLoader = currentMatch != null && !isNewRouteInstance(currentMatch, match) && (currentLoaderData == null ? void 0 : currentLoaderData[match.route.id]) !== void 0;
